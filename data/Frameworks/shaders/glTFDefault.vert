...
void main() 
{
	...
	gl_Position = uboScene.projection * uboScene.view * uboModel.model * skinMat * vec4(inPos, 1.0);
	
	outNormal = normalize(transpose(inverse(mat3(uboScene.view * uboModel.model * skinMat))) * inNormal);
