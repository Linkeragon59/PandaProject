...
namespace Render
{
	...
	void SimpleGeometryModelData::FillWithPreset(Preset aPreset)
	{
		switch (aPreset)
		{
		case Render::SimpleGeometryModelData::Preset::VectorBaseWidget:
			FillVectorBaseWidget();
			break;
		case Render::SimpleGeometryModelData::Preset::Square:
			FillSquare();
			break;
		case Render::SimpleGeometryModelData::Preset::Cube:
			FillCube();
			break;
		case Render::SimpleGeometryModelData::Preset::Disc:
			FillDisc();
			break;
		case Render::SimpleGeometryModelData::Preset::Sphere:
			FillSphere();
			break;
		case Render::SimpleGeometryModelData::Preset::Panda:
			FillPanda();
			break;
		default:
